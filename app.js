...
var adrenaline_clap = new Audio(encodeURIComponent("Samples/Clap/Cymatics - Adrenaline Clap.wav"));
var multistack_clap = new Audio(encodeURIComponent("Samples/Clap/Cymatics - Multistack Clap.wav"));

var dimension_cymbal = new Audio(encodeURIComponent("Samples/Cymbal/Cymbal - Dimension Crash.wav"));
var gravel_cymbal = new Audio(encodeURIComponent("Samples/Cymbal/Cymbal- Gravel Crash.wav"));
